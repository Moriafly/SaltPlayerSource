...
| Официальные релизы в китайских магазинах приложений | 1.荣耀应用市场 <br>2.[荣耀应用市场](https://appmarket-h5.cloud.honor.com/h5/share/latest/index.html?shareId=1842107500028387328&shareTo=copyLink) <br>3.[荣耀应用市场](http://app.xiaomi.com/detail/1610743) <br>4.[荣耀应用市场](https://url.cloud.huawei.com/sztUvRf1XW) <br> *Указанные выше магазины отсортированы в порядке перечисления, а ссылка для скачивания Salt Player в OPPO 软件商店 пока не найдена* | Версии для магазинов в материковом Китае | 1.Данная версия доступна только на архитектуре arm64-v8a <br> 2.Доступна только в материковом Китае <br> 3.Будет выбрана специальная стабильная версия или специальная производственная версия, которая отличается от стандартной стратегии обновления пакетов <br> 4.Из-за модерации или по другим причинам скорость обновления или номер версии в разных магазинах приложений могут отличаться |
