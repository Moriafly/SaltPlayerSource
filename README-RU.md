...
Salt Player (Salt and Pepper Music) - это приложение для воспроизведения музыки на платформе Android. Этот репозиторий используется для публикации обновлений новой версии Salt and Pepper Music, сбора отзывов и отправки уведомлений
...
| Official | 1. Oppo App Market <br> 2. AppGallery <br> 3. Xiaomi GetApps | Версии для КНР | 1. Данная версия доступна только на архитектуре arm64-v8a <br> 2. Доступно только на территории КНР <br> 3. Рекомендуется как канал выпуска стабильных версий, в отличие от стандартной версии <br> 4. По разным причинам могут быть различия в скорости обновления или номере версии в разных магазинах приложений |
...
| OPPO ColorOS | Fluid Cloud | 🟠 Планируется | После проверки работы функции требуется специальные тесты порта, пожалуйста, подождите |
